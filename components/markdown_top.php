...
' : '';
    ...
    <div class="btn-group">
        ...
        <a href="#" class="btn btn-white btn-icon" aria-label="Button" title="Colored text">
        ...
        <a href="#" class="btn btn-white btn-icon" aria-label="Button" title="Youtube">
        ...
        <a href="#" class="btn btn-white btn-icon" aria-label="Button" title="Spotify playlist">
    ...
    $textarea = '<textarea class="form-control" name="example-textarea-input" rows="25" placeholder="Content.."></textarea>';
